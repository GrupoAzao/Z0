...
leaw $4, %A
movw %A, %D
leaw $600, %A   ;i=contador onde vai ser o proximo numero
...
leaw $601, %A 		; Carrega 601 para A
subw (%A), %D, (%A) ; Subtrai D de A[601] e armazena no A[601]
movw (%A),%D 		; Move A[601] para D
...
LOOP_IMPAR:   ;pega o valor de A[(i-1)/2]+A[(i+1)/2]  e coloca no A[602]

;vai fazer o A[(i-1)/2] e colocar no A[602]
leaw $600, %A
movw (%A), %D
decw %D
leaw $601,%A   ;i-1
...
;vai fazer o A[(i+1)/2] e colocar no A[603]
leaw $600, %A
movw (%A), %D
incw %D
leaw $601,%A
...
;faz a soma A[(i-1)/2]+A[(i+1)/2] e coloca no A[602]
leaw $603, %A
movw (%A),%D
leaw $602, %A
addw (%A),%D,(%A)
